...
class Face_Recognizer:
    def __init__(self):
        ...
        self.cap.set(3, 250) # set video widht
        self.cap.set(4, 250) # set video height
    ...
    def draw_name(self, img_rd):
        ...
        if len(aaa)!=2:aaa=["","0"]
        cv2.putText(img_rd, self.bbb[int(aaa[1])], self.current_frame_face_position_list[0], self.font, 0.8, self.color, 1, cv2.LINE_AA)
