...
btn1=tk.Button(root,text="新增照片", width=30,bg='light green',font= ('Noto Sans Mono CJK TC Regular',30),command=lambda:New_person()).pack(side='left', fill='y')
btn2=tk.Button(root,text="更新", width=30,bg='deep sky blue',font= ('Noto Sans Mono CJK TC Regular',30),command=lambda:update()).pack(side='left', fill='y')
btn3=tk.Button(root,text="人臉辨識", width=30,bg='hot pink',font= ('Noto Sans Mono CJK TC Regular',30),command=lambda:fd()).pack(side='left', fill='y')
