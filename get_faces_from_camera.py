...
class Face_Register:
    ...
    def process(self, stream):
        ...
        while stream.isOpened():
            ...
            if kk == ord('n'):
                ...
                self.classnumber=input("請輸入學號.....")
                print(self.classnumber)
                self.writeclassnumber()
            ...
            if len(faces) != 0:
                ...
                for k, d in enumerate(faces):
                    ...
                    if (d.right()+ww) > 640 or (d.bottom()+hh > 480) or (d.left()-ww < 0) or (d.top()-hh < 0):
                        ...
                        save_flag = 0
                        if kk == ord('s'):
                            print("請移動位置 / Please adjust your position")
                    else:
                    ...
                    if save_flag:
                        ...
                        if kk == ord('s'):
                            ...
                            if self.press_n_flag:
                                ...
                                print("寫入local端 / Save into：", str(current_face_dir) + "/img_face_" + str(self.ss_cnt) + ".jpg")
                            else:
                                print("请先按 'N' 來建文件夾, 再按 'S' / Please press 'N' and press 'S'")
    ...
    def run(self):
        ...
        cap.set(3, 220) # set video widht
        cap.set(4, 220) # set video height
